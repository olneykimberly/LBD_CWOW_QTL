...
# Input directory
indir <- '/tgen_labs/jfryer/kolney/LBD_CWOW/QTL/LBD_CWOW_QTL/snp_array/TOPMED_imput'
# Output directory 
qcdir <- '/tgen_labs/jfryer/kolney/LBD_CWOW/QTL/LBD_CWOW_QTL/snp_array/TOPMED_imput'
# Name of the SNP array input data 
name <- 'gwas_filtered_data' #  CWOW_n598_GRCh38_updated
```
...
```{r individual_qc, eval=FALSE}
prefixMergedDataset <- c("TOPMED_imputmerge_HAP_CWOW_filtered_final") 
...
ggsave("../results/plinkQC_plots/per_individual_check_imputed_2026.pdf", width = 8.5, height = 11)
```
...
ggsave("../results/plinkQC_plots/sex_check_2026.pdf", width = 6, height = 5)
```
