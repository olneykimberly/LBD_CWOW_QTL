...
for (subset in subsets) {
  ...
  output_file_trans <- file.path("../MatrixEQTL/", paste0("trans_eQTL_", subset))
  output_file_cis <- file.path("../MatrixEQTL/", paste0("cis_eQTL_", subset))
  ...
  output_table <- paste0("../MatrixEQTL/summary_", subset, ".txt")
