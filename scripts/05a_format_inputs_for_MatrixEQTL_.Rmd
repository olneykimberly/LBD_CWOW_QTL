...
meta$disease_status <- ifelse(meta$TYPE == "AD", 2, 
                              ifelse(meta$TYPE == "LBD", 2, 1))
...
meta <- meta[, c(1, 44, 54)] # RIn 44, disease status 61, batch 52-59
...
data_numeric <- data.frame(lapply(df1_reordered, function(x) {
  # Try to convert to numeric, suppress warnings
...
# Output the table 
write.table(covars, "../snp_array/covariates_and_phenotype_files/covariates_with_disease_status_batch.txt", 
