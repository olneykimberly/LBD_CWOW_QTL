...
genotype_raw <- fread("../snp_array/Filtered_n579_CWOW.clean_genotype.raw")
...
write.table(genotype_data, file = "../snp_array/Filtered_n579_CWOW_genotype_data.txt", sep = " ", quote = FALSE, col.names = NA)
```
...
write.table(TPM_counts, "../RNA_counts/n579_TPM_combat_adjusted_counts.txt", sep = "\t", quote = FALSE)
...
write.table(TPM_counts, "../RNA_counts/n579_TPM_counts.txt", sep = "\t", quote = FALSE)
```
```
