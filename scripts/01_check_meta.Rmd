...
metadata <- read.delim("../expression_metadata.txt")
...
```{r fam}
# read in .fam data
fam <- fread("/research/labs/neurology/fryer/projects/LBD_CWOW/snp_array/632_CWOW.fam")
...
write.table(exclude_IID, "exclude_fam_IID.txt")
...
filtered_fam <- subset(fam, IID %in% test$IID)

write.table(filtered_meta, "../filtered_metadata.txt")
```
